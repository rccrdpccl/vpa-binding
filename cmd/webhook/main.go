...
import (
	...
	"github.com/rccrdpccl/bindings/pkg/reconciler/vpabinding"
)

var types = map[schema.GroupVersionKind]resourcesemantics.GenericCRD{
	v1alpha1.SchemeGroupVersion.WithKind("VPABinding"): &v1alpha1.VPABinding{},
}

func NewDefaultingAdmissionController(ctx context.Context, cmw configmap.Watcher) *controller.Impl {
	return defaulting.NewAdmissionController(ctx,
		// Name of the resource webhook.
		"defaulting.webhook.bindings.rccrdpccl.dev",
...
func NewValidationAdmissionController(ctx context.Context, cmw configmap.Watcher) *controller.Impl {
	return validation.NewAdmissionController(ctx,
		// Name of the resource webhook.
		"validation.webhook.bindings.rccrdpccl.dev",
...
func NewConfigValidationController(ctx context.Context, cmw configmap.Watcher) *controller.Impl {
	return configmaps.NewAdmissionController(ctx,
		...
		"config.webhook.bindings.rccrdpccl.dev",
...
func NewBindingWebhook(resource string, gla psbinding.GetListAll, wc psbinding.BindableContext) injection.ControllerConstructor {
	return func(ctx context.Context, cmw configmap.Watcher) *controller.Impl {
		return psbinding.NewAdmissionController(ctx,
			// Name of the resource webhook.
			fmt.Sprintf("%s.webhook.bindings.rccrdpccl.dev", resource),
...
func main() {
	...
	sharedmain.WebhookMainWithContext(ctx, "webhook",
		...
		vpabinding.NewController, NewBindingWebhook("vpabindings", vpabinding.ListAll, nop),
	)
}
