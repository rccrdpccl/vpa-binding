...
import (
	...
	externalversions "github.com/rccrdpccl/bindings/pkg/client/informers/externalversions"
	client "github.com/rccrdpccl/bindings/pkg/client/injection/client"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/rccrdpccl/bindings/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
