...
// BindingsV1alpha1Client is used to interact with features provided by the bindings.rccrdpccl.dev group.
type BindingsV1alpha1Client struct {
	restClient rest.Interface
}

func (c *BindingsV1alpha1Client) VPABindings(namespace string) VPABindingInterface {
	return newVPABindings(c, namespace)
}
